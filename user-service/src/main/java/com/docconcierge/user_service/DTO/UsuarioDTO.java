package com.docconcierge.user_service.DTO;
...
public class UsuarioDTO {
    ...
    public UsuarioDTO(Long id, String nome, String cpf, String email, String cargo, String descricaoHorario, String gestorResponsavel, Integer cargaHorariaSegunda, Integer cargaHorariaTerca, Integer cargaHorariaQuarta, Integer cargaHorariaQuinta, Integer cargaHorariaSexta, Integer cargaHorariaSabado, Integer cargaHorariaDomingo, LocalDate dataNascimento, LocalDate dataAdmissao, LocalDate dataDemissao, String senha, Long departamentoId, Long filialId) {
        this.id = id;
        this.nome = nome;
        this.cpf = cpf;
        this.email = email;
